...
import com.atguigu.gulimall.oms.service.WmsWareOrderTaskService;
...
@Api(tags = "库存工作单 管理")
@RestController
@RequestMapping("oms/wmswareordertask")
public class WmsWareOrderTaskController {
    ...
    @GetMapping("/list")
    @PreAuthorize("hasAuthority('oms:wmswareordertask:list')")
    ...
    @ApiOperation("详情查询")
    @GetMapping("/info/{id}")
    @PreAuthorize("hasAuthority('oms:wmswareordertask:info')")
    ...
    @ApiOperation("保存")
    @PostMapping("/save")
    @PreAuthorize("hasAuthority('oms:wmswareordertask:save')")
    ...
    @ApiOperation("修改")
    @PostMapping("/update")
    @PreAuthorize("hasAuthority('oms:wmswareordertask:update')")
    ...
    @ApiOperation("删除")
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('oms:wmswareordertask:delete')")
